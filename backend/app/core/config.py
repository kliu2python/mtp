...
class Settings(BaseSettings):
    ...
    # Appium
    APPIUM_ANDROID_URL: str = os.getenv(
    ...
    DEVICE_NODES_API_URL: str = os.getenv(
        "DEVICE_NODES_API_URL", "http://10.160.13.118:8090")
    ...
    JENKINS_API_TOKEN: str = os.getenv(
        "JENKINS_API_TOKEN", "118eed0315e68f05695c4db245f358f2d0")
    JOB_PATH: dict = {
    ...
    MANTIS_TABLE_NAME: str = os.getenv(
        "MANTIS_TABLE_NAME", "issues_49_FortiToken")
